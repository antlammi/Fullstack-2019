...
const CreateNew = withRouter(CreateNewRedirect)
...
const App = () => {
  ...
  const vote = (id) => {
    const anecdote = anecdoteById(anecdotes, id)
    ...
    return (
      <div>
        <Router>
          ...
          <Anecdote anecdote={anecdoteById(props.anecdotes, match.params.id)}/>
        } />
          </div>
        </Router>
